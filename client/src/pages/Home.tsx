...
const Home = () => {
  ...
  return (
    <div className='px-5 inset-0 z-10 flex items-center justify-center'>
      <div className='bg-white opacity-95 max-w-2xl h-auto p-5 mt-20 md:mt-32 rounded-2xl shadow-lg text-center'>
        <h1 className='text-xl font-bold mb-4'>Welcome to BobbleHeads!</h1>
