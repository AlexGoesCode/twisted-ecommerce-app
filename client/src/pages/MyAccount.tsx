...
const MyAccount = () => {
  ...
  return (
    <div className='relative bg-white p-4 sm:p-10 w-screen sm:w-3/5 xl:w-3/5 max-h-96 sm:h-96 mt-10 sm:mt-36 shadow-lg rounded-2xl overflow-hidden'>
      ...
      <h2 className='text-lg md:text-xl font-semibold mb-2'>Orders History:</h2>
      <div className='h-5/6 sm:h-96 overflow-y-auto p-2 md:p-4'>
        {orders && orders.length > 0 ? (
          ...
          <p className='text-center text-xs md:text-sm'>You have no orders.</p>
        )}
      </div>
    </div>
    // </div>
